...
# apology, the usage-limit notice, or the partial reply from a turn that was
# cut short (codex_cli "aborted", e.g. an approval refusal). Only stop_reason
# distinguishes those from a real answer.
_FAILED_STOP_REASONS = {"error", "usage_limit", "aborted"}
