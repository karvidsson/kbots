...
[![CI](https://img.shields.io/github/actions/workflow/status/karvidsson/kbots/ci.yml?branch=main&label=CI)](https://github.com/karvidsson/kbots/actions/workflows/ci.yml)
