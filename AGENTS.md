...
- Only example configs (`config/*.example`, `agents/rescue/AGENTS.md.example`)

### What does NOT belong in Core

- Identities of client agents — AGENTS.md/CLAUDE.md files belonging to specific named agents
